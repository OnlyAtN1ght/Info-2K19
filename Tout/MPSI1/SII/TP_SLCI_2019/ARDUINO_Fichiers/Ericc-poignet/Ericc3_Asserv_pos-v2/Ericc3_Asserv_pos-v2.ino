...
int choisirMenu()
   ...
   // Serial.println("      *                                          *"));
    ...
    Serial.println(F("      - Asservissement en position    --->   2"));
 ...
 // choix correcteur--------------------------------------------------------------------------                
                ...
                while(OK== false){
                 ...
                 // fin choix correcteur-------------------------------------------------------------
                  Serial.println(F("  Entrer une consigne de position en points  [-24570 ..24570]"));
                OK=false;              
                while(OK== false){
                  // si quelque chose sur port serie,le lire :  
                  while (Serial.available() > 0) {               
                        ...
                        if (Serial.read() == '\n') {
                          ...
                          ech = constrain(iech,-24570, 24570);    //limiter Kp              
                          // affiche :
                          Serial.print(F("  Consigne= "));
                          Serial.print(ech);Serial.println(F("  [pt]"));
                          OK=true;
                        } // fin if Serial
                     Serial.println("--------------------"); 
...
void Fait_echelon()
{
                ...
                itest++;
                  ...
                  Fait_PWM(0);
                   ...
                   n=0;
                   while (n<nb) {
                        Serial.print(rest[n]/1.0e6,3);Serial.print("; ");  Serial.print(Consigne,0);Serial.print("; ");
                        Serial.print(resv[n],0);Serial.print("; ");//
